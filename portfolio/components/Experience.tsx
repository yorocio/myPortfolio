  ...
  return (
    <section id="experience" className="space-y-6" >
      ...
      <div>
        ...
        <ul className="list-disc list-inside mt-2 space-y-1 text-[#e2fccb]">
          ...
          <li className="my-2">Participación en la immplementación de despliegues en Netlify, optimizando tiempos de carga.</li>
          <li className="my-2">
