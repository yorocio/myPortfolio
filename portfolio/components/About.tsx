    ...
    <section id="about" className="space-y-4">
      ...
      <div className="text-[#e2fccb] text-lg">
        ...
        <p>
          ...
          con criterio y adaptabilidad. 
        </p>
        <p>Actualmente me encuentro enfocada en perfeccionar mis habilidades full stack, aplicando buenas prácticas, optimización y despliegue automatizado.</p>
      </div>
    </section>
  );
}
